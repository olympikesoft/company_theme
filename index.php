...
<div class="main_portfolio_content">
                              ...
                              $sqls = "Select * from Projects order by id";
                              ...
                              $num_ro = mysqli_num_rows($results);
                              ...
                              while($rows = mysqli_fetch_array($results))
                              {
                               ...
                               <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                                    <img src="/uploads/<?php echo $rows['image_url'];?> " alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6><?php echo $rows['name'];?></h6>
                                      <!---<p class="product_price"> ></p>--->
                                        <a href="/projects.php?id=<?php echo $rows['id'];?>" class="btn btn-primary">View details</a>
                                    </div>
                                </div>
                                <?php
                              }
                              }else{
                                  echo "<center><h2>Dont have Games yet</h2></center>";
                              }
                              ?>
                            </div>
                            </div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-12 text-center">
                    ...
                    <h4 class="section-subheading text-muted">Last 4 posts</h4>
                </div>
